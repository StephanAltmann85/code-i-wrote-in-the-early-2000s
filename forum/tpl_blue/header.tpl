...
<tr class="logobackground">
 <td  style="border-top: 1px #000000 solid; border-left: 1px #000000 solid;" align="left"><if($style['logoimage']!="")><then><a href="index.php{$SID_ARG_1ST}"><img src="{$style['logoimage']}" border="0" alt="$master_board_name" title="$master_board_name" /></a></then></if></td>
