...
<if($_REQUEST[action] == "enter_step2")><then>
...
<if($_REQUEST[action] == "enter_step3")><then>
...
<if($_REQUEST[action] == "enter_save")><then>
<table style="width:100%; height: 100%;" cellpadding="0" cellspacing="0" border="0">
<tr>
 <td valign="middle" align="center"><span class="normalfont"><if($saved == "done")><then>{$lang->items['LANG_LOCATOR_MESSAGE_SAVED']}</then><else>{$lang->items['LANG_LOCATOR_MESSAGE_ERROR']}</else></if><br /><br>
