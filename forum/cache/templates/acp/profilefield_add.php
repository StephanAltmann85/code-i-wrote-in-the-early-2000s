...
/*
acp template
templatename: profilefield_add
*/

$this->templates['acp_profilefield_add']="<?xml version=\\\"1.0\\\" encoding=\\\"{\$lang->items['LANG_GLOBAL_ENCODING']}\\\"?>
...
<table cellpadding=\\\"4\\\" cellspacing=\\\"1\\\" border=\\\"0\\\" class=\\\"tblborder\\\" width=\\\"100%\\\" align=\\\"center\\\">
  <tr class=\\\"tblhead\\\">
   <td colspan=\\\"2\\\">{\$lang->items['LANG_ACP_GLOBAL_MENU_PROFILEFIELD_ADD']}</td>
  </tr>
  <tr class=\\\"firstrow\\\">
   <td><b>{\$lang->items['LANG_ACP_PROFILEFIELD_TITLE']}</b></td>
   <td><input type=\\\"text\\\" name=\\\"title\\\" value=\\\"\\\" maxlength=\\\"100\\\" /></td>
  </tr>
  <tr class=\\\"secondrow\\\">
  ...
  <tr class=\\\"secondrow\\\">
   ...
   <td><select name=\\\"fieldtype\\\" onchange=\\\"changeFieldType(this.options[this.selectedIndex].value);\\\">
		<option value=\\\"text\\\" selected=\\\"selected\\\">{\$lang->items['LANG_ACP_PROFILEFIELD_FIELDTYPE_TEXT']}</option>
		<option value=\\\"select\\\">{\$lang->items['LANG_ACP_PROFILEFIELD_FIELDTYPE_SELECT']}</option>
		<option value=\\\"checkbox\\\">{\$lang->items['LANG_ACP_PROFILEFIELD_FIELDTYPE_CHECKBOX']}</option>
		<option value=\\\"date\\\">{\$lang->items['LANG_ACP_PROFILEFIELD_FIELDTYPE_DATE']}</option>
		<option value=\\\"multiselect\\\">{\$lang->items['LANG_ACP_PROFILEFIELD_FIELDTYPE_MULTISELECT']}</option>
   </select></td>
  </tr>
  <tr class=\\\"firstrow\\\">
   <td>{\$lang->items['LANG_ACP_PROFILEFIELD_FIELDTYPE_HINT']}</td>
   <td><textarea name=\\\"fieldoptions\\\" rows=\\\"6\\\" cols=\\\"50\\\"></textarea></td>
  </tr>
  <tr class=\\\"secondrow\\\">
   <td><b>{\$lang->items['LANG_ACP_PROFILEFIELD_MAXLENGTH']}</b><br />{\$lang->items['LANG_ACP_PROFILEFIELD_MAXLENGTH_DESC']}</td>
   <td><input type=\\\"text\\\" name=\\\"maxlength\\\" value=\\\"\\\" maxlength=\\\"5\\\" /></td>
  </tr>
   <tr class=\\\"firstrow\\\">
   <td><b>{\$lang->items['LANG_ACP_PROFILEFIELD_FIELDSIZE']}</b><br />{\$lang->items['LANG_ACP_PROFILEFIELD_FIELDSIZE_DESC']}</td>
   <td><input type=\\\"text\\\" name=\\\"fieldsize\\\" value=\\\"\\\" maxlength=\\\"3\\\" /></td>
  </tr>
  <tr class=\\\"secondrow\\\">
   <td><b>{\$lang->items['LANG_ACP_PROFILEFIELD_FIELDORDER']}</b><br />{\$lang->items['LANG_ACP_PROFILEFIELD_FIELDORDER_DESC']}</td>
   <td><input type=\\\"text\\\" name=\\\"fieldorder\\\" value=\\\"\\\" maxlength=\\\"7\\\" /></td>
  </tr>
   <tr class=\\\"firstrow\\\">
   <td><b>{\$lang->items['LANG_ACP_PROFILEFIELD_CHOICECOUNT']}</b><br />{\$lang->items['LANG_ACP_PROFILEFIELD_CHOICECOUNT_DESC']}</td>
   <td><input type=\\\"text\\\" name=\\\"choicecount\\\" value=\\\"\\\" maxlength=\\\"3\\\" /></td>
  </tr>
  <tr class=\\\"secondrow\\\">
