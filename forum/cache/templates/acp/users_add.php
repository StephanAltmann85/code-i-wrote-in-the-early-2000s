...
/*
acp template
templatename: users_add
*/

$this->templates['acp_users_add']="<?xml version=\\\"1.0\\\" encoding=\\\"{\$lang->items['LANG_GLOBAL_ENCODING']}\\\"?>
...
<input type=\\\"hidden\\\" name=\\\"sid\\\" value=\\\"\$session[hash]\\\" />
 ...
 <table cellpadding=\\\"4\\\" cellspacing=\\\"1\\\" width=\\\"100%\\\" class=\\\"tblborder\\\" align=\\\"center\\\">
  <tr class=\\\"tblhead\\\">
   <td colspan=\\\"2\\\">{\$lang->items['LANG_ACP_GLOBAL_MENU_USERS_ADD']}</td>
  </tr>
  <tr class=\\\"tblsection\\\">
  ...
  <tr class=\\\"firstrow\\\">
   ...
   <td><input type=\\\"password\\\" name=\\\"password\\\" maxlength=\\\"50\\\" value=\\\"\$password\\\" /></td>
  </tr>
  <tr class=\\\"secondrow\\\">
  ...
  <tr class=\\\"firstrow\\\">
   ...
   <td><textarea rows=\\\"7\\\" cols=\\\"55\\\" name=\\\"signature\\\">\$signature</textarea>
   </td>
  </tr>
  \$userfields
  <tr class=\\\"tblsection\\\">
  ...
  <tr class=\\\"firstrow\\\">
   <td valign=\\\"top\\\"><b>{\$lang->items['LANG_ACP_USERS_AVATAR']}</b></td>
   <td><table>
    <tr>
