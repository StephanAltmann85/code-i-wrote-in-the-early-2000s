...
<body>
 ...
 <table cellpadding=4 cellspacing=1 width=\\\"100%\\\" class=\\\"tblborder\\\" align=\\\"center\\\">
  ...
  <tr class=\\\"tblsection\\\">
   <td colspan=2>Templatepack wählen</td>
  </tr>
  <tr class=\\\"firstrow\\\">
  ...
  <tr class=\\\"secondrow\\\">
   <td colspan=2 align=\\\"center\\\"><input type=\\\"submit\\\" value=\\\"Speichern\\\"> <input type=\\\"reset\\\" value=\\\"Zurücksetzen\\\"> <input type=\\\"button\\\" value=\\\"Abbrechen\\\" onclick=\\\"window.location.href='template.php?action=view&templatepackid=\$templatepackid&sid=\$session[hash]'\\\"></td>
  </tr>
 </table></form>
</body>
</html>";
