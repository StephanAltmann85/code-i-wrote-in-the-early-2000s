...
/*
acp template
templatename: template_export_select
*/

$this->templates['acp_template_export_select']="<tr class=\\\"firstrow\\\">
    <td width=\\\"70%\\\">
    ...
    <p>Auf der linken Seite können Sie einzelne Templates auswählen, die exportiert werden sollen.</p>
