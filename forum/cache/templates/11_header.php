 ...
 <tr>
  <td class=\\\"mainpage\\\" align=\\\"center\\\"><br />
   <table style=\\\"width:{\$style['tableinwidth']}\\\" border=\\\"0\\\" cellspacing=\\\"1\\\" cellpadding=\\\"1\\\" class=\\\"tableoutborder\\\">
    <tr> 
     <td class=\\\"tableb\\\" align=\\\"leftf\\\">\".((\$style['logoimage']!=\"\") ? (\"<a href=\\\"index.php{\$SID_ARG_1ST}\\\"><img src=\\\"{\$style['logoimage']}\\\" border=\\\"0\\\" alt=\\\"\$master_board_name\\\" title=\\\"\$master_board_name\\\" /></a>\") : (\"\")).\"</td>
    </tr>
    <tr>
     <td align=\\\"center\\\" class=\\\"tablea\\\"><span class=\\\"smallfont\\\">\".((\$wbbuserdata['userid']) ? (\"<a href=\\\"usercp.php{\$SID_ARG_1ST}\\\"><img src=\\\"{\$style['imagefolder']}/top_usercp.gif\\\" border=\\\"0\\\" alt=\\\"{\$lang->items['LANG_GLOBAL_USERCP']}\\\" title=\\\"{\$lang->items['LANG_GLOBAL_USERCP']}\\\" /></a>
