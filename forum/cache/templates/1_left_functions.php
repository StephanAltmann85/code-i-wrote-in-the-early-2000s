...
/*
templatepackid: 1
templatename: left_functions
*/

$this->templates['left_functions']="<table style=\\\"width:100%\\\" cellpadding=\\\"4\\\" cellspacing=\\\"0\\\" border=\\\"0\\\">
    <tr>
     <td style=\\\"width:100%\\\" class=\\\"smallfont\\\">
\".((\$wbbuserdata['userid']) ? (\"<a href=\\\"search.php?action=new{\$SID_ARG_2ND}\\\"><b>{\$lang->items['LANG_GLOBAL_NEW_POSTS']}</b></a><br />
<br />
...
<br />
<a href=\\\"javascript:noticepopup()\\\">{\$lang->items['LANG_GLOBAL_NOTICE']}</a><br />\") : (\"\")).\"
