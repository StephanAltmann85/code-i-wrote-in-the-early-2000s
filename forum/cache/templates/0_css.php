...
select {
 \".((\$style['selectfontsize']!=\"\") ? (\"font-size: {\$style['selectfontsize']}px;\") : (\"\")).\"
...
textarea {
 \".((\$style['textareafontsize']!=\"\") ? (\"font-size: {\$style['textareafontsize']}px;\") : (\"\")).\"
...
.input {
 \".((\$style['inputfontsize']!=\"\") ? (\"font-size: {\$style['inputfontsize']}px;\") : (\"\")).\"
