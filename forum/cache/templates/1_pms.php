   ...
   <tr>
    <td style=\\\"width:230px;\\\" valign=\\\"top\\\">
     ...
     \".((\$user_folder_count < \$wbbuserdata['max_pms_folders']) 
      ? (\"
        <tr>
         <td class=\\\"tabletitle\\\" colspan=\\\"\".((\$folder_bit) ? (\"4\") : (\"3\")).\"\\\" align=\\\"center\\\"><form action=\\\"pms.php\\\" method=\\\"post\\\"><span class=\\\"normalfont\\\"><b>{\$lang->items['LANG_PMS_CREATE_FOLDER']}</b></span></td>
        </tr>
        <tr align=\\\"left\\\">
         <td class=\\\"tablea\\\"><img src=\\\"{\$style['imagefolder']}/msg-folder.gif\\\" alt=\\\"\\\" title=\\\"\\\" border=\\\"0\\\" /></td>
         <td class=\\\"tableb\\\" style=\\\"width:100%\\\" colspan=\\\"\".((\$folder_bit) ? (\"3\") : (\"2\")).\"\\\" align=\\\"center\\\"><input type=\\\"text\\\" name=\\\"foldertitle\\\" maxlength=\\\"100\\\" value=\\\"\\\" class=\\\"input\\\" />&nbsp;<input src=\\\"{\$style['imagefolder']}/go.gif\\\" type=\\\"image\\\" />
       </td>
        </tr>
     ...
     \".((\$folderid!=\"outbox\" && \$folderid!=0) 
      ? (\"
       <form action=\\\"pms.php\\\" method=\\\"post\\\">
        <tr>
         <td class=\\\"tabletitle\\\" colspan=\\\"\".((\$folder_bit) ? (\"4\") : (\"3\")).\"\\\" align=\\\"center\\\"><span class=\\\"normalfont\\\"><b>{\$lang->items['LANG_PMS_RENAME']}</b></span></td>
        </tr>
        <tr align=\\\"left\\\">
         <td class=\\\"tablea\\\"><img src=\\\"{\$style['imagefolder']}/msg-folder.gif\\\" alt=\\\"\\\" title=\\\"\\\" border=\\\"0\\\" /></td>
         <td class=\\\"tableb\\\" style=\\\"width:100%\\\" colspan=\\\"\".((\$folder_bit) ? (\"3\") : (\"2\")).\"\\\" align=\\\"center\\\"><input type=\\\"text\\\" name=\\\"foldertitle\\\" maxlength=\\\"100\\\" value=\\\"\$folder[title]\\\" class=\\\"input\\\" />&nbsp;<input src=\\\"{\$style['imagefolder']}/go.gif\\\" type=\\\"image\\\" /></td>
        </tr>
      ...
      <tr>
       <td class=\\\"tabletitle\\\" colspan=\\\"\".((\$folder_bit) ? (\"4\") : (\"3\")).\"\\\" align=\\\"center\\\"><span class=\\\"normalfont\\\"><b>{\$lang->items['LANG_PMS_DATA_USAGE']}</b></span></td>
      </tr>
      <tr>
       <td align=\\\"left\\\" class=\\\"tablea\\\" colspan=\\\"\".((\$folder_bit) ? (\"4\") : (\"3\")).\"\\\"><span class=\\\"smallfont\\\">{\$lang->items['LANG_PMS_FOLDER_USAGE']}</span></td>
      </tr>
     </table>
    </td>
   ...
   \".((\$action==\"tracking\") 
    ...
    : (\"
       ...
       <td style=\\\"width:100%\\\" valign=\\\"top\\\"><form action=\\\"pms.php\\\" method=\\\"post\\\">
        ...
        <table cellpadding=\\\"{\$style['tableincellpadding']}\\\" cellspacing=\\\"{\$style['tableincellspacing']}\\\" border=\\\"{\$style['tableinborder']}\\\" class=\\\"tableinborder\\\" style=\\\"width:100%\\\">
         <tr align=\\\"center\\\">
          <td class=\\\"tabletitle\\\" colspan=\\\"\".((\$folderid==\"outbox\") ? (\"2\") : (\"3\")).\"\\\" style=\\\"width:60%\\\"><span class=\\\"normalfont\\\"><b><a href=\\\"pms.php?folderid=\$folderid&amp;sortfield=subject&amp;sortorder=\".((\$sortfield == 'subject' && \$sortorder == 'ASC') ? (\"DESC\") : (\"ASC\")).\"{\$SID_ARG_2ND}\\\">{\$lang->items['LANG_PMS_TITLE_SUBJECT']}</a></b></span> \".((\$sortfield == 'subject') ? (\"<a href=\\\"pms.php?folderid=\$folderid&amp;sortfield=\$sortfield&amp;sortorder=\".((\$sortorder == 'DESC') ? (\"ASC\") : (\"DESC\")).\"{\$SID_ARG_2ND}\\\"><img src=\\\"{\$style['imagefolder']}/\".((\$sortorder == 'DESC') ? (\"sortasc.gif\") : (\"sortdesc.gif\")).\"\\\" alt=\\\"\\\" border=\\\"0\\\" /></a>\") : (\"\")).\"</td>
          <td class=\\\"tabletitle\\\" style=\\\"width:20%\\\"><span class=\\\"normalfont\\\"><b>\".((\$folderid==\"outbox\") ? (\"{\$lang->items['LANG_PMS_TITLE_TO']}\") : (\"<a href=\\\"pms.php?folderid=\$folderid&amp;sortfield=username&amp;sortorder=\".((\$sortfield == 'username' && \$sortorder == 'ASC') ? (\"DESC\") : (\"ASC\")).\"{\$SID_ARG_2ND}\\\">{\$lang->items['LANG_PMS_TITLE_BY']}</a>\")).\"</b></span>\".((\$folderid != 'outbox') ? (\" \".((\$sortfield == 'username') ? (\"<a href=\\\"pms.php?folderid=\$folderid&amp;sortfield=\$sortfield&amp;sortorder=\".((\$sortorder == 'DESC') ? (\"ASC\") : (\"DESC\")).\"{\$SID_ARG_2ND}\\\"><img src=\\\"{\$style['imagefolder']}/\".((\$sortorder == 'DESC') ? (\"sortasc.gif\") : (\"sortdesc.gif\")).\"\\\" alt=\\\"\\\" border=\\\"0\\\" /></a>\") : (\"\")).\"\") : (\"\")).\"</td>
          <td class=\\\"tabletitle\\\" style=\\\"width:20%\\\"><span class=\\\"normalfont\\\"><b><a href=\\\"pms.php?folderid=\$folderid&amp;sortfield=sendtime&amp;sortorder=\".((\$sortfield == 'sendtime' && \$sortorder == 'ASC') ? (\"DESC\") : (\"ASC\")).\"{\$SID_ARG_2ND}\\\">{\$lang->items['LANG_PMS_TITLE_DATE']}</a></b></span> \".((\$sortfield == 'sendtime') ? (\"<a href=\\\"pms.php?folderid=\$folderid&amp;sortfield=\$sortfield&amp;sortorder=\".((\$sortorder == 'DESC') ? (\"ASC\") : (\"DESC\")).\"{\$SID_ARG_2ND}\\\"><img src=\\\"{\$style['imagefolder']}/\".((\$sortorder == 'DESC') ? (\"sortasc.gif\") : (\"sortdesc.gif\")).\"\\\" alt=\\\"\\\" border=\\\"0\\\" /></a>\") : (\"\")).\"</td>
