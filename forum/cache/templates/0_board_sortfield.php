<?php
			/*
			templatepackid: 0
			templatename: board_sortfield
			*/
			
			$this->templates['board_sortfield']="<select name=\\\"sortfield\\\">
                ...
                \".((\$board['allowratings']==1) ? (\"<option value=\\\"vote\\\" \$f_select[vote]>{\$lang->items['LANG_BOARD_SORTFIELD_VOTE']}</option>\") : (\"\")).\"
