<?php
			/*
			templatepackid: 0
			templatename: codephptag
			*/
			
			$this->templates['codephptag']="<table align='center' style='width:98%; table-layout: fixed;'>
 <tr>
  <td><div style='\".((\$filename != 'print.php') ? (\"overflow: auto; height: {\$height}px; \") : (\"\")).\"width: 100%;'>
   <table cellpadding='4' cellspacing='1' style='width:100%' class='tableinborder'>
    <tr class='smallfont'>
     <td class='tablecat'\".((\$linenumbers!=\"\") ? (\" colspan='2'\") : (\"\")).\"><span class='smallfont'><b>{\$lang->items['LANG_GLOBAL_PHPCODE']}</b></span></td>
    </tr>
    <tr class='smallfont'>
