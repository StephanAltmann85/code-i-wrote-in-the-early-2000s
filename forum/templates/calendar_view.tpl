...
<if($wbbuserdata['can_public_event']==1)>
	<then><a href="calendar.php?action=addevent&amp;type=public{$SID_ARG_2ND}"><img src="{$style['imagefolder']}/publicevent.gif" border="0" alt="" title="" /></a></then>
</if>&nbsp;
<if($wbbuserdata['can_private_event']==1)>
	<then><a href="calendar.php?action=addevent&amp;type=private{$SID_ARG_2ND}"><img src="{$style['imagefolder']}/privateevent.gif" border="0" alt="" title="" /></a></then>
</if>
</span></td>
